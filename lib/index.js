...
exports.default = options => {
  ...
  process.env('unhandledRejecion', err => _logger2.default.error(`Unhandled rejection: ${ err && err.stack || _util2.default.inspect(err) }`));
  ...
  (0, _parseHandlers2.default)(config.handlers).forEach((method, url, handler) => app[method](url, wrap(handler)));
